...
{
  /**
   * Returns the add-on ID used by Stop All Ads
   */
  get addonID()
  {
  ...
  /**
   * Returns the installed Stop All Ads version
   */
  get addonVersion()
  {
  ...
  /**
   * Returns the user interface locale selected for stopallads chrome package.
   */
  get appLocale()
  {
    let locale = "en-US";
    try
    {
      locale = Utils.chromeRegistry.getSelectedLocale("stopallads");
    }
    catch (e)
    {
      Cu.reportError(e);
  ...
  getString: function(name)
  {
    ...
    let stringBundle = Services.strings.createBundle("chrome://stopallads/locale/global.properties?" + Math.random());
