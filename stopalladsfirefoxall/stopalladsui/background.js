...
(function(global)
{
  ...
  modules.utils = {
    Utils: {
      ...
      {
        return "http://www.stopallads.com/redirect?link=" + encodeURIComponent(link);
      },
      get appLocale()
      {
  ...
  var prefs = {
    ...
    subscriptions_exceptionsurl: "http://stopallads.s3.amazonaws.com/subscriptions/exceptionrules.txt"
  };
  ...
  modules.subscriptionClasses = {
    Subscription: function(url)
    {
      ...
      this.homepage = "https://easylist.stopallads.org/";
  ...
  var subscriptions = [
    "http://stopallads.s3.amazonaws.com/subscriptions/easylistgermany_easylist.txt",
    "http://stopallads.s3.amazonaws.com/subscriptions/exceptionrules.txt",
    "http://stopallads.s3.amazonaws.com/subscriptions/fanboy-social.txt",
    "~user~786254"
  ];
