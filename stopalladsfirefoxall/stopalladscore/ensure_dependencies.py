...
A dependencies file should look like this:
  ...
  _root = hg:https://hg.stopallads.org/ git:https://github.com/stopallads/
  ...
  # Clone the stopallads repository into stopallads directory, overwriting the
  # usual source URL for Git repository and specifying VCS specific revision IDs.
  stopallads = stopallads hg:893426c6a6ab git:git@github.com:user/stopallads.git@b2ffd52b
  # Clone the stopalladschrome repository into the stopalladschrome directory,
  # from a specific Git repository, specifying the revision ID.
  stopalladschrome = git:git@github.com:user/stopalladschrome.git@1fad3a7
"""
