...
/**
 * Tracks preference changes, calls reloadDisabledFilters whenever Stop All Ads
 * is enabled/disabled.
 */
...
function doClose()
{
  mainWin.document.getElementById("saa-command-sidebar").doCommand();
}
...
function detach(doDetach)
{
  ...
  myMainWin.document.getElementById("saa-command-sidebar").doCommand();
