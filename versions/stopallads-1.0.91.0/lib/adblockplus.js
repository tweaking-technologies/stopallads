...
require.scopes["subscriptionInit"] = (function()
{
  ...
  function getSubscriptions()
  {
    ...
    if (firstRun)
    {
      var subscriptions_easyprivacy = Subscription.fromURL(Prefs.subscriptions_easyprivacy);
      subscriptions_easyprivacy.title = "Allow Easy Privacy List";
      subscriptions.push(subscriptions_easyprivacy);
      var subscriptions_easylistadware = Subscription.fromURL(Prefs.subscriptions_easylistadware);
      subscriptions_easylistadware.title = "Blocks Easylist adware";
      subscriptions.push(subscriptions_easylistadware);
    }
  ...
  function finishInitialization(subscriptions)
  {
    ...
    {
      ext.pages.open(ext.getURL("after-install.html"));
    }
    initNotifications();
  }
