...
DownloadableSubscription.prototype =
{
   ...
   * if the user doesn't use StopAll Ads for some time.
   * @type Number
   */
  get lastCheck()
  {
  ...
  /**
   * Minimal StopAll Ads version required for this subscription
   * @type String
   */
  requiredVersion: null,

  /**
   * Should be true if requiredVersion is higher than current StopAll Ads version
   * @type Boolean
   */
