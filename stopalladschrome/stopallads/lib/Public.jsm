...
/**
 * @fileOverview Public StopAll Ads API.
 */
...
/**
 * Class implementing public StopAll Ads API
 * @class
 */
var AdblockPlus =
{
  ...
  /**
   * Returns installed StopAll Ads version
   */
  ...
  /**
   * Returns source code revision this StopAll Ads build was created from (if available)
   */
