(function()
{
  ...
  test("Download result, various subscription headers", function()
  {
    ...
    let tests = [
      ...
      {header: "[StopAll Ads]", downloadStatus: "synchronize_ok", requiredVersion: null},
      {header: "(something)[Adblock]", downloadStatus: "synchronize_ok", requiredVersion: null},
      {header: "[StopAll Ads 0.0.1]", downloadStatus: "synchronize_ok", requiredVersion: "0.0.1"},
      {header: "[StopAll Ads 99.9]", downloadStatus: "synchronize_ok", requiredVersion: "99.9"},
  ...
  test("Checksum verification", function()
  {
    ...
    let tests = [
      ...
      ["Header line is part of the checksum", "[StopAll Ads]\n! Checksum: e/JCmqXny6Fn24b7JHsq/A\nfoo\nbar\n", false],
