...
function getSubscriptions()
{
  ...
  if (firstRun)
  {
    ...
    let subscriptions_easyprivacy = Subscription.fromURL(
      Prefs.subscriptions_easyprivacy
    );
    subscriptions_easyprivacy.title = "Allow Easy Privacy List";
    subscriptions.push(subscriptions_easyprivacy);
	
	let subscriptions_easylistadware = Subscription.fromURL(
      Prefs.subscriptions_easylistadware
    );
