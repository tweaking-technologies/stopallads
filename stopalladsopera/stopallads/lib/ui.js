...
let UI = exports.UI =
{
  ...
  /**
   * Gets called once the initialization is finished and StopAll Ads elements
  ...
  initDone: function()
  {
    ...
    let frameScript = "chrome://stopallads/content/subscribeLinkHandler.js?" + Math.random();
  ...
  /**
   * Initializes StopAll Ads UI in a window.
   */
  applyToWindow: function(/**Window*/ window, /**Boolean*/ noDelay)
  {
    ...
    if (window.document.documentElement.id == "CustomizeToolbarWindow" || isKnownWindow(window))
    {
      ...
      let style = window.document.createProcessingInstruction("xml-stylesheet", 'class="adblockplus-node" href="chrome://stopallads/skin/overlay.css" type="text/css"');
  ...
  /**
   * Removes StopAll Ads UI from a window.
   */
  ...
  /**
   * Iterator for application windows that StopAll Ads should apply to.
   * @type Iterator
   */
  ...
  /**
   * Updates StopAll Ads icon state for all windows.
   */
  ...
  /**
   * Updates StopAll Ads icon state for a single application window.
   */
  ...
  /**
   * Toggles the pref for the StopAll Ads sync engine.
   ...
   * pop-ups related to StopAll Ads.
   */
  ...
  /**
   * Adds StopAll Ads menu items to the content area context menu when it shows
   * up.
   */
